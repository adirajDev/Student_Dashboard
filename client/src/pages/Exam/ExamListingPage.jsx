                        ...
                        <div className="sticky top-[100px]">
                            <div className="">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3">
                                            {['Online', 'Offline'].map(modeValue => {
                                                const isChecked = Array.isArray(filters.mode) && filters.mode.includes(modeValue);
                                                return (
                                                    <label key={modeValue} className="flex items-center gap-3 cursor-pointer group">
                                                        <input 
                                                            type="checkbox" 
                                                            className="hidden" 
                                                            checked={isChecked}
                                                        ...
                                                        <span className="text-sm font-medium text-[var(--foreground)]">{modeValue}</span>
                                                    </label>
                                                );
                                            })}
                                        </div>
                                    ...
                                    {(filters.status !== 'all' || (Array.isArray(filters.mode) && filters.mode.length > 0) || filters.month !== 'all') && (
                                        <button
                                            onClick={() => {
                                                setFilters({
                                                    status: 'all',
