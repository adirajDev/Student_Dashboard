        ...
        <main className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="bg-[var(--card)] p-5 md:p-6 rounded-3xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all group">
                    ...
                    <p className="text-xl font-semibold text-[var(--foreground)]">{user.course?.name || user.course || 'N/A'}</p>
                </div>
                ...
                <div className="bg-[var(--card)] p-5 md:p-6 rounded-3xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all group">
                    ...
                    <p className="text-xl font-semibold text-[var(--foreground)]">{user.college?.name || user.college || 'N/A'}</p>
                </div>
