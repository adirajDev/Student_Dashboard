...
import CollegeManagementSection from '@/features/college/admin/components/CollegeManagementSection.jsx';
import PendingUpdatesSection from '@/features/college/updates/components/Admin/PendingUpdatesSection';
...
import PromotionManagementSection from '@/features/promotions/components/PromotionManagementSection.jsx';
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            ...
            {activeTab === 'promotions' && isAdmin && (
                <div className="animate-fade-in">
                    <PromotionManagementSection title="Promotions" />
                </div>
            )}
        </div>
    );
