                    ...
                    <nav className="flex flex-col gap-2 mt-2">
                        ...
                        {isStudent && (
                            <>
                                <NavItem
                                    ...
                                    onClick={() =>
                                        handleNav('/dashboard?tab=overview')
                                    }
                                />
                                <NavItem
                                    ...
                                    onClick={() =>
                                        handleNav('/dashboard?tab=reviews')
                                    }
                                />
                            </>
                        )}
                        ...
                        {(isAdmin || isEditor) && (
                            <NavItem
                                ...
                                isActive={activeTab === 'overview'}
                                onClick={() =>
                                    handleNav('/admin/dashboard?tab=overview')
                                }
                            />
                        )}
                        ...
                        {isAdmin && (
                            <NavItem
                                ...
                                onClick={() =>
                                    handleNav('/admin/dashboard?tab=editors')
                                }
                            />
                        )}
                        ...
                        {(isAdmin || isEditor) && (
                            <NavItem
                                ...
                                onClick={() =>
                                    handleNav('/admin/dashboard?tab=students')
                                }
                            />
                        )}
                        ...
                        {isAdmin && (
                            <NavItem
                                ...
                                onClick={() =>
                                    handleNav('/admin/dashboard?tab=courses')
                                }
                            />
                        )}
                        ...
                        {isAdmin && (
                            <>
                                ...
                                <NavItem
                                    ...
                                    onClick={() =>
                                        handleNav(
                                            '/admin/dashboard?tab=collegeUsers'
                                        )
                                    }
                                />
                                <NavItem
                        ...
                        {isCollege && (
                            <>
                                <NavItem
                                    ...
                                    onClick={() =>
                                        handleNav('/college/dashboard?tab=edit')
                                    }
                                />
                                <NavItem
                                    icon={<Star className="w-5 h-5" />}
